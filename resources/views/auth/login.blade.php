<x-guest-layout>
    <div class="mb-4">
        ...
        <h2 class="h2 mb-2">Accéder à l'espace de gestion</h2>
        <p class="text-muted mb-0">Connectez-vous pour gérer les filières, apprenants, notes et exports du centre.</p>
    </div>
